...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tution Zone — Teacher & Student Portal" },
      {
        name: "description",
        content: "Class scheduling and attendance for teachers and students.",
      },
      { property: "og:title", content: "Tution Zone — Teacher & Student Portal" },
      {
      ...
      { name: "apple-mobile-web-app-title", content: "Tution Zone" },
    ],
    links: [
...
function RootComponent() {
  ...
  // Installable app (PWA / APK wrapper) + system notification support.
  useEffect(() => {
